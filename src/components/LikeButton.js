...
function LikeButton({id, token, like}) {
  ...
  return (<>
    {!Liked ? <AiIcons.AiOutlineHeart onClick={toggle} className='LikeButton' title="Add to 'Your Music' library"/> :
               <AiIcons.AiFillHeart className='LikeButton'  title="Remove from 'Your Music' library" onClick={toggle}/>}
